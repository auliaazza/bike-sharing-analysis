...
with st.sidebar:
    ...
    col1, col2 = st.columns (2)
    with col1:
        st.page_link("www.linkedin.com/in/azzahraa248", label="LinkedIn", icon="linkedin")
    with col2:
        st.page_link("https://github.com/auliaazza/bike-sharing-analysis", label="Github", icon="github")
